...
**Want a single file you can just double-click, with no dev server running?** Run `npm run build` after `npm install` — that creates `dist/index.html`, which you can open directly in a browser from then on.
